...
//from pidautotune to 110C
  
     #define  DEFAULT_bedKp 219.58
 #define  DEFAULT_bedKi 32.29
 #define  DEFAULT_bedKd 373.26
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,80,119.768}  // default steps per unit for Ultimaker
